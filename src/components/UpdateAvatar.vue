                ...
                <div class="button-container">
                    <div>
                        <van-uploader v-model="fileList" :preview-image="false" :before-read="beforeRead" :after-read="afterRead" :accept="'image/*'">
                            <template #default>
                                <van-button icon="plus" type="primary" plain round>选择图片</van-button>
                            </template>
                        </van-uploader>
                    </div>
                    <div>
                        <van-button block round type="primary" native-type="submit" @mousedown="uploadAvatar" :disabled="form.allowSubmit" class="upload">上传</van-button>
                    </div>
                </div>
            </li>
