...
<template>
    <div class="main">
        <div class="main-container">
            <van-sticky>
                <van-nav-bar title="提醒列表" left-text="返回" left-arrow @click-left="onBack" @click-right="router.push({path: '/index'})">
                    <template #right>
                        ...
                        <div class="top-container">
                            <div class="left-layout">
                                <div class="userInfo">
                                    ...
                                    <div v-if="remind.senderAccount == null || remind.senderAccount == ''" class="cancelAccount">此用户账号已注销</div>
                                </div>
...
<script lang="ts" setup>
    ...
    watchEffect(() => {
        ...
        if(titleValue != null && titleValue != ''){
            document.title = '提醒列表 - ' + titleValue;
        }
    }, {
