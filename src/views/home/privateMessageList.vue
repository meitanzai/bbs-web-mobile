...
<template>
    <div class="main">
        <div class="main-container">
            <van-sticky>
                <van-nav-bar title="私信列表" left-text="返回" left-arrow @click-left="onBack" @click-right="router.push({path: '/index'})">
                    <template #right>
                        ...
                        <div class="top-container">
                            <div class="left-layout">
                                <div class="userInfo">
                                    ...
                                    <div v-if="privateMessage.friendAccount == null || privateMessage.friendAccount == ''" class="cancelAccount">此用户账号已注销</div>
                                </div>
...
<script lang="ts" setup>
    ...
    watchEffect(() => {
        ...
        if(titleValue != null && titleValue != ''){
            document.title = '私信列表 - ' + titleValue;
        }
    }, {
