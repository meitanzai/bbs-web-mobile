...
<template>
    <div class="main">
        <div class="main-container">
            <van-sticky>
                <van-nav-bar title="收红包列表" left-text="返回" left-arrow @click-left="onBack" @click-right="router.push({path: '/index'})">
                    <template #right>
                        ...
                        <div v-for="(receiveRedEnvelope,index) in state.receiveRedEnvelopeList" :key="receiveRedEnvelope.id" class="item van-hairline--bottom">
                            <div class="top-container">
                                <div class="userInfo">
                                    ...
                                    <div v-if="receiveRedEnvelope.giveAccount == null || receiveRedEnvelope.giveAccount == ''" class="cancelAccount">此用户账号已注销</div>
                                </div>
...
<script lang="ts" setup>
    ...
    watchEffect(() => {
        ...
        if(titleValue != null && titleValue != ''){
            document.title = '收红包列表 - ' + titleValue;
        }
    }, {
