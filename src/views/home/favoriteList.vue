...
<template>
    <div class="main">
        <div class="main-container">
            <van-sticky>
                <van-nav-bar title="收藏夹" left-text="返回" left-arrow @click-left="onBack" @click-right="router.push({path: '/index'})">
                    <template #right>
                    ...
                    <div v-for="(favorites,index) in state.favoritesList" :key="favorites.id" class="item van-hairline--bottom">
                        <div class="top-container">
                            <div class="left-layout">
                                <div class="topicTag" v-if="favorites.module == 10">话题</div>
                                <div class="questionTag" v-if="favorites.module == 20">问题</div>
                            </div>
