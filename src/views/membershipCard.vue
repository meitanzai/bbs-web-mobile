...
<template>
    <div class="main">
        <div class="main-container">
            <van-sticky>
                <van-nav-bar title="会员卡" left-text="返回" left-arrow @click-left="onBack" @click-right="router.push({path: '/index'})">
                    <template #right>
                ...
                <div class="membershipCardModule">
                    <div class="item" v-for="(specification,index) in state.membershipCard.specificationList">
                        ...
                        <div class="right-layout">
                            <van-button round block type="primary" native-type="submit" :disabled="state.buttonDisabled[index]"  @click="addMembershipCardOrder(index,specification.id);">立即购买</van-button>
                        </div>
                    </div>
