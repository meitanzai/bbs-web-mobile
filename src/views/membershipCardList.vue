                ...
                <div class="membershipCardListModule">
                    <div class="item" v-for="membershipCard in state.membershipCardList">
                        ...
                        <div class="bottom-container">
                            <div class="layout">
                                <van-button round block plain type="primary" native-type="submit" :to="{path: '/membershipCard', query: {membershipCardId: membershipCard.id}}">查看详情</van-button>
                            </div>
                        </div>
                    </div>
                </div>
...
<script lang="ts" setup>
    ...
    watchEffect(() => {
        ...
        if(titleValue != null && titleValue != ''){
            document.title = '会员卡套餐 - ' + titleValue;
        }
    }, {
