...
<template>
    <div class="main">
        <div class="main-container">
            <van-sticky>
                <van-nav-bar title="帮助内容" left-text="返回" left-arrow @click-left="onBack" @click-right="router.push({path: '/index'})">
                    <template #right>
            ...
            <van-pull-refresh v-model="state.isRefreshing" success-text="刷新成功" pull-distance="200" @refresh="onRefresh" style="min-height: 50vh;">
                <div class="helpContentModule">
                    ...
                    <div class="helpDetail"  v-if="!state.isSkeleton">
                        <div class="name">{{state.help.name}}</div>
                        <div class="time van-hairline--bottom">{{state.help.times}}</div>
                        <div class="content" :ref="'help_'+state.help.id">
                            <RenderTemplate @click-onZoomPicture="onZoomPicture" :html="state.help.content"></RenderTemplate>
